...
# Updated AntikytheraRings with centered layout and distinct rotating image rings per celestial body
...
class SplitCanvasApp(App):
    def build(self):
        ...
        display = AntikytheraRings(size_hint=(1, 0.85))
        control_area = BoxLayout(orientation='vertical', size_hint=(1, 0.15), padding=5, spacing=5)
